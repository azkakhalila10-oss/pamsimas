...
Route::post('/register', [PelangganController::class, 'storeRegisterWarga'])->name('register.store');
...
Route::middleware(['auth'])->group(function () {
    ...
    // TAMBAHKAN BARIS INI UNTUK TOMBOL "CETAK":
...
}); // <--- PENUTUP AREA ADMIN (Tadi kurang baris ini!)

// ==========================================
// RUTE WARGA (Bisa Diakses Bebas Tanpa Login)
// ==========================================
